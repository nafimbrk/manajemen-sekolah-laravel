<x-mainlayout title="Class">


<div class="mt-16 mb-4 flex justify-between items-center mx-auto">
    <h1 class="font-bold text-xl">CLass List</h1>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        @else
                            ...
                            <a class="font-medium text-white bg-yellow-400 px-2 py-2 rounded dark:text-blue-500 hover:underline"
                                    ...
                                    <form id="delete-form-{{ $data->id }}" action="/class/destroy/{{ $data->id }}" method="POST" style="display: inline-block">
                                        @csrf
                                        @method('DELETE')
